...
<body>
	...
	<header>
    	<div>
        	...
        	<div id="syqz"><span class="hebei">河北</span><span class="shanye">山叶</span>&nbsp;<span class="hebei">起重机械制造有限公司</span></div>
        	<div id="zyw">
            	<a href="#"><img src="images/zh.jpg"/><span class="zh">中文版</span></a>
                &nbsp;
            	<a href="#"><img src="images/en.jpg"/><span class="zh">English</span></a>
            </div>
    ...
    <menu>
        ...
        <li><a href="page/guest.jsp">留言反馈</a></li>/li>
    </menu>
    ...
    <footer>
        ...
        <p class="p1">(C)Copyright 2016 版权所有：河北山叶起重机械制造有限公司 &nbsp;地址:河北省保定市清苑区东吕工业园区 &nbsp;邮编:071100【<a href="mail.jsp" target="_blank">企业邮箱登陆</a>】 </p>
         <p class="p2">&nbsp;&nbsp;电话：13722237047 13303028262 &nbsp;&nbsp; E-mail：hbsyqzjx@foxmail.com</p>
         <p class="p3">技术支持：<a href="tiao.asp" target="_blank">猿动力工作室</a> </p>
    </footer>
</body>
</html>
